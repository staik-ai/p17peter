...
class Flipper extends React.Component {
     ...
     */
    render(){
        return <div className={classNames("cards", this.props.className)}>
            {this.getRange(this.props.now).map((val, i) =>{
                return <div
                    ...
                    <div className={classNames("sides", this.props.sidesWrapClassName)}>
                        {["front", "back"].map(key => <div
                            key={`side${key}`}
                            className={classNames("side", this.props.sideClassName, key)}>
                            <div className={classNames("side-num", this.props.numClassName)}>
